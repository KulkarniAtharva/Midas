...
import dev.atharvakulkarni.midas.databinding.SarvGavTalavBinding;

public class sarv_gav_talav extends AppCompatActivity
{
    SarvGavTalavBinding sarvGavTalavBinding;
    PieChart pieChart;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        sarvGavTalavBinding = DataBindingUtil.setContentView(this, R.layout.sarv_gav_talav);

        getWindow().setStatusBarColor(getResources().getColor(R.color.white,getTheme()));

        pieChart = sarvGavTalavBinding.chart1;
