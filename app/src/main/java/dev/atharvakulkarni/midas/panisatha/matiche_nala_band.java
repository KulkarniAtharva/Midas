...
import dev.atharvakulkarni.midas.databinding.MaticheNalaBandBinding;

public class matiche_nala_band extends AppCompatActivity
{
    MaticheNalaBandBinding maticheNandBandBinding;
    PieChart pieChart;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        maticheNandBandBinding = DataBindingUtil.setContentView(this, R.layout.matiche_nala_band);

        getWindow().setStatusBarColor(getResources().getColor(R.color.white,getTheme()));

        pieChart = maticheNandBandBinding.chart1;
        ...
        back = maticheNandBandBinding.back;
